  ...
  return (
    <div className="navbar">
      ...
      <div className="navbar-right">
        <img
          className="nav-icons nav-search"
          src={assets.search_icon}
          alt=""
          onClick={() => setIsSearchVisible((prev) => !prev)}
        />
        <SearchDropdown isVisible={isSearchVisible} />

        <div className="navbar-search-icon">
          <div onClick={emptyCartHandler}>
            <img
              className="nav-icons nav-cart"
        ...
        {!token ? (
          ...
          <div className="nav-profile">
            <img
              ...
              className="nav-icons nav-profile"
